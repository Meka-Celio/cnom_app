            ...
            if ($user) {
                ...
                if ($valideMail) {
                    ...
                    if ($card == 'NAT') {
                        ...
                        $frais = number_format(($montant/96.46)*100*0.0358,2);
                    }
                    ...
                    var_dump($_verifCotisation);

                    if ($_verifCotisation == 0) {
                        header("Location:view.noPaid.php?msg=no_old_year&year=$Annee");
                    }
                    else if ($_verifCotisation == -1) {
                        header("Location:view.noPaid.php?msg=no_all_years&year=$Annee");
                    }
                    else {
    ...
    if (isset($_GET['action'])) {
        ...
        switch($_GET['action']) {
            ...
            -------------------------------------------------*/
                (function () {
                    if (isset($_POST['card'])) {
                        preparePaiement($_POST['card'], $_POST['montant'], $_POST['CINMedecin'], $_POST['cache'], $_POST['year']);
                    }
                    else {
            ...
            case 'ticketPaiement':
                (function() {
                    ...
                    if (isset($_GET['CIN'])) {
                        ...
                        $VerifCotisation        =       verifCotisation($CIN, $AnneeCotisation, 0);
                        $TypeMail               =       0;
