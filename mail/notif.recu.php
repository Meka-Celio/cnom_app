...
$secteur = "Olive";
$specialite = "Marche";
$date_diplome = "15-04-2018";
$date_installation_recrutement = "11-11-2011";
$daterecu = date('Y-m-d');
$adresse_pro = "Casa";
...
<p style='margin: 0; font-size: 18px; mso-line-height-alt: 36px;'><span style='font-size:18px;'>RECU N : $numrecu</span></p>
<p style='margin: 0; font-size: 18px; mso-line-height-alt: 36px;'><span style='font-size:18px;'>Montant : $montant DHS</span></p>
</div>
</div>
</td>
</tr>
...
<div style='font-family: sans-serif'>
<div style='font-size: 14px; mso-line-height-alt: 28px; color: #17365d; line-height: 2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;'>
<p style='margin: 0; font-size: 14px; mso-line-height-alt: 32px;'><span style='font-size:16px;'>Recu du Dr : <strong>$nom_medecin</strong></span><br/><span style='font-size:16px;'>La somme de : <strong>$somme</strong></span><br/><span style='font-size:16px;'>Pour paiement de la cotisation au titre de l'annee : <strong>$annee</strong></span><br/><span style='font-size:16px;'>Mode de paiement : Paiement en ligne N: <strong>$numcommande </strong></span></p>
